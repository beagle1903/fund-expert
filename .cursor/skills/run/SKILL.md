...
2. Parse the JSON result. Require `status: "success"`, `api.status: "healthy"`, and `ui.status: "healthy"` before claiming the app is ready.
...
- Do not start a second copy of a healthy component.
